...
namespace AscomWebApp
{
    public class HomeController : Controller
    {
        ...
        // Metodo per ottenere i dati JSON via AJAX per aggiornamenti dinamici
        //[HttpGet]
        //public async Task<IActionResult> GetPatientsJson()
        //{
        //    var patientsList = await _patientService.GetPatientsAsync();
        //    return Json(patientsList ?? new List<GetDataPatient>());
        //}
    }
}
